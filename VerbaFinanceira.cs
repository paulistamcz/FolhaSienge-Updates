...
public class VerbaFinanceira
{
    ...
    public static List<VerbaFinanceira> Lista() => new()
    {
        ...
        new() { Codigo = 58,   Descricao = "FGTS - NORMAL", PlanoFinanceiro = "2.01.02.11", Credor = "CAIXA ECONOMICA FEDERAL", CredorCodigo = "37", Documento = "FGTS", FormaPagamento = "CEF Tributos / contas de consumo" },
        ...
        new() { Codigo = 10,   Descricao = "IRRF 0561", PlanoFinanceiro = "2.01.02.16", Credor = "MINISTERIO DA FAZENDA", CredorCodigo = "298", Documento = "0561", FormaPagamento = "CEF Tributos / contas de consumo" },
        new() { Codigo = 11,   Descricao = "DARF-DCTFWEB", PlanoFinanceiro = "2.01.02.10", Credor = "MINISTERIO DA FAZENDA", CredorCodigo = "298", Documento = "DWEB", FormaPagamento = "CEF Tributos / contas de consumo" },
